...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    console.log('App: Container dimensions', { width: containerWidth, height: containerHeight });
    ...
    this.camera = new THREE.PerspectiveCamera(options.fov, containerWidth / containerHeight, 0.1, 10000);
  ...
  tick() {
    ...
    this.animationFrameId = requestAnimationFrame(() => {
      ...
      if (resizeRendererToDisplaySize(this.renderer, this.setSize, this.container)) {
        const width = this.container.clientWidth || window.innerWidth;
        const height = this.container.clientHeight || window.innerHeight;
        this.camera.aspect = width / height;
        this.camera.updateProjectionMatrix();
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  useEffect(() => {
    ...
    console.log('Hyperspeed: effectOptions reference changed?', effectOptions !== prevOptionsRef.current);
